...
@JsonTypeInfo(
        ...
        property = "type")
@JsonSubTypes({ @JsonSubTypes.Type(value = ExecTask.class, name = "EXEC"), @JsonSubTypes.Type(value = FetchArtifactTask.class, name = "FETCH_ARTIFACT"), @JsonSubTypes.Type(value = FetchMaterialTask.class, name = "FETCH_MATERIAL"), @JsonSubTypes.Type(value = UploadArtifactTask.class, name = "UPLOAD_ARTIFACT") })
