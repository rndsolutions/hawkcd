...
"C:\Program Files (x86)\MSI Factory\Wix\light.exe" -loc "English-US.wxl" -b "C:\GitRepos\hawkcd\build_\win\Installers" -out "HawkCD_Server.msi" "HawkCD_Server.wixobj" "msifactui.wixobj" "Common.wixobj" "ErrorText.wixobj" "ProgressText.wixobj"
if ERRORLEVEL 1 goto error
