...
public final class Constants {
    ...
    public static final String SERVER_CREATE_ARTIFACT_API_ADDRESS = "api/exec/artifacts/create";
    public static final String SERVER_FETCH_ARTIFACT_API_ADDRESS = "api/exec/artifacts/fetch/zip";
}
