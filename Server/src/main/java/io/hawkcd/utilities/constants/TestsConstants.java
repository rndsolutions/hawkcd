...
public class TestsConstants {
    public static final int TESTS_COLLECTION_SIZE_NO_OBJECTS = 0;
    ...
    public static final String SERVICE_RESULT_NOT_FOUND_MESSAGE = "%s not found.";
    public static final String SERVICE_RESULT_ALREADY_EXISTS = "%s already exists.";
}
