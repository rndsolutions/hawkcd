...
public class EnvelopAdapter implements JsonDeserializer<Envelop> {
    @Override
    public Envelop deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        ...
        Envelop result = new Envelop(resultObject);
