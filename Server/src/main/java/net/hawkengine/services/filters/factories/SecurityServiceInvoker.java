...
public class SecurityServiceInvoker<T extends DbEntry> {
    ...
    public boolean changeUserPasswrod(String loggedUserPasswrod, String entity, String className, List<Permission> permissions, String methodName) {
        switch (methodName) {
            case "changeUserPassword":
                return this.securityService.changeUserPassword(loggedUserPasswrod, entity, className, permissions);
            default:
                return false;
        }
    }
